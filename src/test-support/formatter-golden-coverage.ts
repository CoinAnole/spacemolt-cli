...
const GOLDEN_COVERAGE_OPT_OUTS: Record<string, string> = {
  ...
  facility_get: 'Route is absent from current OpenAPI metadata; renderer-only fixture coverage remains until a schema-backed replacement exists.',
  ...
  faction_trade_intel: 'Schema-backed command is faction_query_trade_intel; legacy alias renderer coverage remains outside the high-value schema matrix.',
