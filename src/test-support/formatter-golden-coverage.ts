...
const REQUIRED_HIGH_VALUE_FIXTURE_LABELS: Record<string, string> = {
  ...
  catalog_skills_one: 'catalog',
  inspect_catalog_skill: 'inspect',
  ...
  faction_list_missions_empty: 'faction_list_missions',
  distress_signal_no_responders: 'distress_signal',
  faction_scan_poi_empty: 'faction_scan_poi',
  faction_scan_poi_partial: 'faction_scan_poi',
  get_action_log_cursor: 'get_action_log',
  get_battle_log_arena: 'get_battle_log',
  get_battle_log_hunt: 'get_battle_log',
  ...
  get_battle_summary_arena: 'get_battle_summary',
  ...
  get_active_missions_community: 'get_active_missions',
  get_active_missions_exchange: 'get_active_missions',
  jump_missions: 'jump',
  dock_missions_cargo: 'dock',
  survey_system_missions: 'survey_system',
  get_missions_bounty: 'get_missions',
  get_missions_community: 'get_missions',
  get_missions_exchange: 'get_missions',
  ...
  subscribe_observation_arena: 'subscribe_observation',
