...
export const getNotificationsPirateRadioFixture = {
  ...
  current_tick: 902100,
  remaining: 0,
  timestamp: 1779565000,
  notifications: [
    {
      id: 'notif-pirate-radio-tactical-1',
      type: 'system',
    ...
    {
      id: 'notif-pirate-radio-ambient-1',
      type: 'system',
      msg_type: 'pirate_radio',
      timestamp: '2026-05-23T19:20:05.000Z',
      data: {
        pirate_name: 'Stronghold Control',
        source_system: 'sol',
        source_poi: '',
        faction_key: 'corsair',
        faction_name: 'Corsair',
        ...
        secondary_color: '#1a1a1a',
        flagship_ship_class: 'raider_frigate',
        event_key: 'idle_chatter',
        message: 'Keep the belt quiet.',
        category: 'ambient',
        editorial_class: 'ambient',
        discord_policy: 'never',
        speaker_category: 'stronghold_control',
        speaker_id: 'stronghold-corsair',
      },
    },
    {
      id: 'notif-pirate-radio-outcome-1',
      type: 'system',
      msg_type: 'pirate_radio',
      timestamp: '2026-05-23T19:20:10.000Z',
      data: {
        pirate_name: 'Dreadnought',
        source_system: 'sol',
        source_poi: 'sol_belt',
        ...
        secondary_color: '#1a1a1a',
        flagship_ship_class: 'raider_frigate',
        event_key: 'raid_resolved',
        message: 'Hull is ours.',
        category: 'outcome',
        editorial_class: 'outcome',
        discord_policy: 'immediate',
        speaker_category: 'boss',
        speaker_id: 'pirate-dreadnought-1',
        battle_id: 'battle-99',
      },
    },
    {
      id: 'notif-pirate-radio-leader-1',
      type: 'system',
      msg_type: 'pirate_radio',
      timestamp: '2026-05-23T19:20:15.000Z',
      data: {
        pirate_name: 'Admiral Kael',
        source_system: 'sol',
        source_poi: 'sol_belt',
...
/** Arena-objective wave/verdict poll (v0.597.0 Notification_arena_objective). Coarse type is system. */
export const getNotificationsArenaObjectiveFixture = {
  count: 4,
  current_tick: 902150,
  remaining: 0,
  timestamp: 1779565500,
  notifications: [
    {
      id: 'notif-arena-objective-wave-1',
      type: 'system',
      msg_type: 'arena_objective',
      timestamp: '2026-05-23T19:25:00.000Z',
      data: {
        event: 'wave_arrived',
        battle_id: 'battle-1',
    ...
    {
      id: 'notif-arena-objective-won-1',
      type: 'system',
      msg_type: 'arena_objective',
      timestamp: '2026-05-23T19:25:05.000Z',
      data: {
        event: 'objective_won',
        battle_id: 'battle-2',
        challenge_id: 'hold_the_ring',
        objective: 'survive_ticks',
        message: 'The ring held.',
      },
    },
    {
      id: 'notif-arena-objective-lost-time-1',
      type: 'system',
      msg_type: 'arena_objective',
      timestamp: '2026-05-23T19:25:10.000Z',
      data: {
        event: 'objective_lost',
        battle_id: 'battle-3',
        challenge_id: 'timed_assault',
        objective: 'time_limit',
        message: 'Time ran out.',
      },
    },
    {
      id: 'notif-arena-objective-lost-escape-1',
      type: 'system',
      msg_type: 'arena_objective',
      timestamp: '2026-05-23T19:25:15.000Z',
      data: {
        event: 'objective_lost',
        battle_id: 'battle-4',
        challenge_id: 'no_escape',
        objective: 'enemy_escaped',
        message: 'A runner escaped the ring.',
      },
    },
  ],
};

/** Facility rent/repossession, station repair, and ranch poaching poll (OpenAPI remainder). */
export const getNotificationsFacilitiesFixture = {
  count: 6,
  current_tick: 902400,
  remaining: 0,
  ...
  notifications: [
    {
      id: 'notif-rent-personal-1',
      type: 'system',
      msg_type: 'facility_rent_warning',
      timestamp: '2026-05-23T19:50:00.000Z',
      data: {
        base_id: 'earth_station',
        base_name: 'Earth Station',
    ...
    {
      id: 'notif-rent-faction-1',
      type: 'system',
      msg_type: 'facility_rent_warning',
      timestamp: '2026-05-23T19:50:05.000Z',
      data: {
        base_id: 'haven_exchange',
        base_name: 'Haven Exchange',
        message: 'Faction facilities are in arrears.',
        credits_owed: 45000,
        facilities_behind: 4,
        missed_cycles: 8,
        grace_cycles: 260,
    ...
    {
      id: 'notif-reclaimed-1',
      type: 'system',
      msg_type: 'facility_reclaimed',
      timestamp: '2026-05-23T19:50:10.000Z',
      data: {
        base_id: 'earth_station',
        base_name: 'Earth Station',
    ...
    {
      id: 'notif-reclaimed-faction-1',
      type: 'system',
      msg_type: 'facility_reclaimed',
      timestamp: '2026-05-23T19:50:15.000Z',
      data: {
        base_id: 'haven_exchange',
        base_name: 'Haven Exchange',
        message: 'Faction facilities were repossessed.',
        facilities: ['Ore Refinery', 'Shipyard'],
        faction_id: 'fac_wardens',
      },
    },
    {
      id: 'notif-station-repaired-1',
      type: 'system',
      msg_type: 'station_repaired',
      timestamp: '2026-05-23T19:50:20.000Z',
      data: {
        base_id: 'earth_station',
        base_name: 'Earth Station',
        system_id: 'sol',
    ...
    {
      id: 'notif-ranch-poached-1',
      type: 'system',
      msg_type: 'ranch_poached',
      timestamp: '2026-05-23T19:50:25.000Z',
      data: {
...
export const notificationsHighValueFixtures: Record<string, HighValueFixtureEntry> = {
  ...
  get_notifications_arena_objective: {
    command: 'get_notifications',
    fixture: getNotificationsArenaObjectiveFixture,
  },
