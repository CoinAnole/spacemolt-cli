...
export const taxEstimateFixture = {
  ...
  outstanding_bounties: [{ empire: 'solarian', bounty: 125 }],
  payment_guidance:
    'Use pay_bounty with empire=solarian and source=self to clear the full 125-credit bounty remotely. prepay_tax does not clear existing debt.',
  last_assessed_at: 1779926400,
  last_property_assessed_at: 1779926400,
  next_assessment_approx_seconds: 3600,
  note: 'Estimate only.',
  latest_statement: {
    period_started_at: '2026-09-07T00:00:00Z',
    assessed_at: '2026-09-14T00:00:00Z',
    tick: 60480,
    preview: false,
    inactivity_exempt: false,
    income_gross: 40000,
    income_by_category: { market: 28000, mission: 12000 },
    market_purchases: 16000,
    loss_carryforward_previous: 2000,
    market_deduction: 18000,
    loss_carryforward_next: 0,
    taxable_income: 22000,
    property_value: 120000,
    ships: [{ ship_id: 'ship-1', value: 120000 }],
    income: [
      {
        empire: 'solarian',
        rate_bps: 500,
        ...
        unpaid: 0,
        brackets: [
          { lower_bound: 0, upper_bound: 50000, rate_bps: 500, income_in_bracket: 22000, tax_from_bracket: 110 },
        ],
      },
    ],
    property: [{ empire: 'solarian', rate_bps: 50, owed: 600, paid: 600, unpaid: 0, brackets: [] }],
    paid_from_prepaid: 150,
    paid_from_wallet: 560,
    refund: 0,
    total_owed: 710,
    total_paid: 710,
    total_unpaid: 0,
