export const CURATED_COMMAND_DESCRIPTIONS: Record<string, string> = {
  ...
  craft: 'Queue a crafting job from station storage.',
  ...
  faction_facility_list: 'List faction facilities at the current base.',
  ...
  facility_set_output_price: 'Set the per-item output price renters pay.',
  ...
  storage: 'View or move station storage, faction storage, gifts, wreck loot, and storage jettison actions.',
