export const CURATED_COMMAND_DESCRIPTIONS: Record<string, string> = {
  ...
  storage: 'Run the unified storage command.',
  storage_jettison: 'Jettison cargo through the storage tool.',
  storage_loot: 'Loot cargo or modules from a wreck through the storage tool.',
