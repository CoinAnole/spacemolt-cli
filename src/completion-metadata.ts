...
export const GLOBAL_COMPLETION_OPTIONS: CompletionOption[] = [
  ...
  {
    long: '--verbose-notifications',
    description: 'Show omitted-field hints and extra scalars on inline notifications',
  },
  ...
  { long: '--fuzzy-ids', description: 'Soft ID-cache payload match; default is exact id/name only' },
  { long: '--no-fuzzy-ids', description: 'Force exact-only ID-cache payload resolution' },
  { long: '--keys', description: 'List keys at a JSON dotpath', takesValue: true },
  { long: '--search', description: 'Filter structured output to matching branches', takesValue: true },
  { long: '--search-keys', description: 'List matching jq paths and keys', takesValue: true },
  { long: '--search-values', description: 'List matching jq paths and scalar values', takesValue: true },
  { long: '--search-regex', description: 'List matching jq paths via regex', takesValue: true },
