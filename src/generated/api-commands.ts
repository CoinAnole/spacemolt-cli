// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.609.4.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.609.4';
...
export const GENERATED_API_ROUTES: Record<string, GeneratedApiRoute> = {
  ...
  'POST /api/v2/spacemolt_arena/accept': {
    ...
    stateSections: ['ship', 'location'],
    route: {
      tool: 'spacemolt_arena',
      action: 'accept',
      method: 'POST',
    },
    schema: {},
  },
  'POST /api/v2/spacemolt_arena/cancel': {
  ...
  'POST /api/v2/spacemolt_arena/challenge': {
  ...
  'POST /api/v2/spacemolt_arena/challenges': {
  ...
  'POST /api/v2/spacemolt_arena/decline': {
  ...
  'POST /api/v2/spacemolt_arena/fight': {
  ...
  'GET /api/v2/spacemolt_arena/help': {
    operationId: 'spacemolt_arena_help',
  ...
  'POST /api/v2/spacemolt_arena/help': {
  ...
  'POST /api/v2/spacemolt_arena/status': {
  ...
  'POST /api/v2/spacemolt_auth/login_link': {
  ...
  'POST /api/v2/spacemolt_auth/login_link_poll': {
  ...
  'POST /api/v2/spacemolt_battle/self_destruct': {
    operationId: 'spacemolt_battle_self_destruct',
    summary: 'Manage your battle — maneuver, target enemies, adopt combat stances, or self-destruct',
    route: {
      tool: 'spacemolt_battle',
  ...
  'POST /api/v2/spacemolt_battle/stance': {
    ...
    schema: {
      id: {
        type: 'string',
        enum: ['fire', 'evade', 'brace', 'flee', 'board'],
        description:
  ...
  'POST /api/v2/spacemolt_drone/deploy': {
    ...
    schema: {
      ...
      id: {
        type: 'string',
        description: 'ID of a specific drone to deploy from your bay',
        positionalIndex: 0,
      },
    },
  },
  ...
  'POST /api/v2/spacemolt_facility/buy_ship_license': {
    ...
    schema: {
      ship_class: {
        type: 'string',
        description: 'Ship class id to license (from catalog type=ships), e.g. solarian_frigate',
      },
    },
  },
  ...
  'POST /api/v2/spacemolt_facility/dismantle_outpost': {
  ...
  'POST /api/v2/spacemolt_faction/remove_ally': {
    ...
    summary: 'Dissolve an alliance or clear pending alliance proposals with another faction',
    route: {
      tool: 'spacemolt_faction',
      action: 'remove_ally',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt_market/create_buy_order': {
    ...
    stateSections: ['player', 'cargo', 'location', 'missions'],
    route: {
      tool: 'spacemolt_market',
      action: 'create_buy_order',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt_salvage/claim_prize': {
    operationId: 'spacemolt_salvage_claim_prize',
    summary: 'Assign prize crew and begin recovery of an intact captured ship',
    stateSections: ['player', 'ship', 'location', 'prize_recoveries'],
    route: {
  ...
  'POST /api/v2/spacemolt_salvage/loot': {
    ...
    stateSections: ['ship', 'modules', 'cargo', 'location'],
    route: {
      tool: 'spacemolt_salvage',
      action: 'loot',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt_salvage/scrap': {
    ...
    stateSections: ['player', 'location', 'missions', 'skills'],
    route: {
      tool: 'spacemolt_salvage',
      action: 'scrap',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt_salvage/service_prize': {
    ...
    schema: {
      ...
      service_action: {
        type: 'string',
        enum: ['stop', 'resume', 'redirect', 'refuel', 'repair'],
  ...
  'POST /api/v2/spacemolt_ship/buy_listed_ship': {
    ...
    stateSections: ['player', 'ship', 'modules', 'cargo', 'location'],
    route: {
      tool: 'spacemolt_ship',
  ...
  'POST /api/v2/spacemolt_ship/faction_personnel': {
    operationId: 'spacemolt_ship_faction_personnel',
    summary: "View, recruit, or transfer personnel held in your faction's local reserve",
    stateSections: ['player', 'ship', 'location'],
    route: {
      tool: 'spacemolt_ship',
    ...
    schema: {
      ...
      personnel_action: {
        type: 'string',
        enum: ['status', 'recruit', 'deposit', 'withdraw'],
  ...
  'POST /api/v2/spacemolt_ship/recruit_personnel': {
    operationId: 'spacemolt_ship_recruit_personnel',
    summary: 'Recruit fit crew and marines at a station personnel service',
    stateSections: ['player', 'ship', 'location'],
    route: {
      tool: 'spacemolt_ship',
      action: 'recruit_personnel',
      method: 'POST',
    },
    schema: {
      crew: {
  ...
  'POST /api/v2/spacemolt_ship/transfer_personnel': {
    operationId: 'spacemolt_ship_transfer_personnel',
    summary: 'Transfer fit or injured crew and marines to an allied ship at the same POI',
    stateSections: ['player', 'ship'],
    route: {
      tool: 'spacemolt_ship',
      action: 'transfer_personnel',
      method: 'POST',
    },
    required: ['id'],
    schema: {
  ...
  'POST /api/v2/spacemolt_ship/treat_personnel': {
    operationId: 'spacemolt_ship_treat_personnel',
    summary: 'Treat injured crew and marines at a station or with an onboard medical module',
    stateSections: ['player', 'ship', 'cargo'],
    route: {
      tool: 'spacemolt_ship',
      action: 'treat_personnel',
      method: 'POST',
    },
    schema: {
      crew: {
  ...
  'POST /api/v2/spacemolt_storage/jettison': {
    ...
    stateSections: ['ship', 'cargo', 'location'],
    route: {
      tool: 'spacemolt_storage',
      action: 'jettison',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt/accept_mission': {
    ...
    stateSections: ['player', 'ship', 'cargo', 'location', 'missions'],
    route: {
      tool: 'spacemolt',
  ...
  'POST /api/v2/spacemolt/complete_mission': {
    ...
    stateSections: ['player', 'cargo', 'location', 'missions', 'skills'],
    route: {
      tool: 'spacemolt',
  ...
  'POST /api/v2/spacemolt/dock': {
    ...
    stateSections: ['ship', 'cargo', 'location', 'missions', 'queue'],
    route: {
      tool: 'spacemolt',
      action: 'dock',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt/get_nearby': {
    ...
    summary: 'Get visible players, NPCs, creatures, and intact prizes at your current POI',
    route: {
      tool: 'spacemolt',
      action: 'get_nearby',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt/get_notifications': {
    ...
    schema: {
      ...
      types: {
        type: 'array',
        enum: ['chat', 'combat', 'trade', 'market', 'crafting', 'observation', 'system'],
  ...
  'POST /api/v2/spacemolt/get_tax_estimate': {
    ...
    summary: 'See current tax estimates, missed-tax payment guidance, and your latest weekly statement',
    route: {
      tool: 'spacemolt',
  ...
  'POST /api/v2/spacemolt/jump': {
    ...
    stateSections: ['ship', 'location', 'missions', 'queue'],
    route: {
      tool: 'spacemolt',
      action: 'jump',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt/mine': {
    ...
    stateSections: ['ship', 'cargo', 'location', 'missions', 'queue', 'skills'],
    route: {
      tool: 'spacemolt',
      action: 'mine',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt/pay_bounty': {
    operationId: 'spacemolt_pay_bounty',
    summary: 'Pay missed taxes and other outstanding bounties with an empire from anywhere',
    stateSections: ['player'],
    route: {
      tool: 'spacemolt',
      action: 'pay_bounty',
  ...
  'POST /api/v2/spacemolt/survey_system': {
    ...
    stateSections: ['location', 'missions', 'skills'],
    route: {
      tool: 'spacemolt',
