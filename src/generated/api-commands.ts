// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.559.1.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.559.1';
  ...
  'POST /api/v2/spacemolt_battle/stance': {
    ...
    schema: {
      id: {
        ...
        description:
          'Battle stance (required when you set a stance): fire (100% dmg dealt/taken), evade (0% dealt, 50% taken, costs fuel), brace (0% dealt, 25% taken, shields regen 2x), flee (0% dealt, 100% taken, auto-retreats to outer zone then a minimum of 3 ticks to escape — longer the slower you are than your fastest pursuer, and never while warp-disrupted)',
        positionalIndex: 0,
      },
    },
  },
  ...
  'POST /api/v2/spacemolt_battle/target': {
    ...
    schema: {
      id: {
        type: 'string',
        description:
          'ID or name of the enemy to target — any combatant in the battle, including pirates, police, drones, creatures and stations (required when you pick a target)',
        positionalIndex: 0,
      },
    },
  },
  ...
  'POST /api/v2/spacemolt_storage/view': {
    ...
    schema: {
      station_id: {
        type: 'string',
        description:
          'Optional: station ID to view storage at without being docked. Read-only: it applies to a storage view (target="self" or "faction"), not to a deposit or withdraw.',
      },
      target: {
        type: 'string',
        description: "Target: 'self' (personal storage), 'faction' (faction storage), or a player name/ID (gift)",
