// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.325.0.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.325.0';
...
export const GENERATED_API_ROUTES: Record<string, GeneratedApiRoute> = {
  ...
  'POST /api/v2/spacemolt_drone/deploy': {
    ...
    schema: {
      id: {
        type: 'string',
        description: 'ID of the drone to deploy from your bay (see get_drones)',
        positionalIndex: 0,
      },
    },
  },
