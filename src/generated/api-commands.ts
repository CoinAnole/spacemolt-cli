// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.529.0.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.529.0';
  ...
  'POST /api/v2/spacemolt_shipping/post': {
    ...
    schema: {
      ...
      service_level: {
        type: 'string',
        enum: ['standard', 'priority'],
        description: 'standard, or priority for a speed bonus that decays toward the deadline.',
      },
      shipper: {
        type: 'string',
        enum: ['player', 'faction'],
