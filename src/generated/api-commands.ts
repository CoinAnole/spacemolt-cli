// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.605.2.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.605.2';
...
export const GENERATED_API_ROUTES: Record<string, GeneratedApiRoute> = {
  ...
  'POST /api/v2/spacemolt_salvage/scrap': {
    ...
    stateSections: ['player', 'location', 'skills'],
    route: {
      tool: 'spacemolt_salvage',
      action: 'scrap',
      method: 'POST',
  ...
  'POST /api/v2/spacemolt/mine': {
    ...
    stateSections: ['ship', 'cargo', 'location', 'queue', 'skills'],
    route: {
      tool: 'spacemolt',
      action: 'mine',
      method: 'POST',
