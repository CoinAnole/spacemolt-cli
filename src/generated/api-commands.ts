// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.417.2.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.417.2';
  ...
  'POST /api/v2/spacemolt_facility/browse_for_sale': {
    ...
    schema: {
      ...
      deliver_to: {
        ...
        description: "Output destination for 'job_add': 'storage' (default) or 'faction' (faction storage).",
      },
      description: {
        type: 'string',
        description:
