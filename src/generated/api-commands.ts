// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.554.1.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.554.1';
  ...
  'POST /api/v2/spacemolt_battle/target': {
    ...
    schema: {
      id: {
        type: 'string',
        description:
          'ID or name of the enemy to target — any combatant in the battle, including pirates, police, drones, creatures and stations (required for action=target)',
        positionalIndex: 0,
      },
    },
  },
  ...
  'POST /api/v2/spacemolt_shipping/deliver': {
    ...
    schema: {
      package_id: {
        type: 'string',
        description:
          'Sealed package ID. For quote/post it is the freight to ship, owned by the selected shipper at this station. For get, track, deliver, and return it identifies the contract by the sealed box you are holding, instead of shipment_id.',
      },
      shipment_id: {
        type: 'string',
        description:
