// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.384.1.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.384.1';
...
export const GENERATED_API_ROUTES: Record<string, GeneratedApiRoute> = {
  ...
  'POST /api/v2/spacemolt_facility/configure_recycler': {
    operationId: 'spacemolt_facility_configure_recycler',
    summary: 'Manage facilities at stations (production, faction, personal, sales, and more)',
    route: {
      tool: 'spacemolt_facility',
