// Generated by scripts/generate-api-metadata.ts from spacemolt-docs/openapi.json for gameserver v0.572.1.
// Do not edit by hand.
...
export const GENERATED_API_GAMESERVER_VERSION = 'v0.572.1';
...
export const GENERATED_API_ROUTES: Record<string, GeneratedApiRoute> = {
  ...
  'POST /api/v2/spacemolt_battle/stance': {
    ...
    schema: {
      ...
      target: {
        type: 'string',
        description: 'ID or name of the enemy — required when focusing a target and when entering the board stance',
        positionalIndex: 1,
      },
    },
  },
  ...
  'POST /api/v2/spacemolt/pay_bounty': {
    ...
    summary: 'Settle your outstanding bounty with an empire from anywhere',
    stateSections: ['player'],
    route: {
      tool: 'spacemolt',
      action: 'pay_bounty',
  ...
  'POST /api/v2/spacemolt/refuel': {
    ...
    schema: {
      ...
      quantity: {
        type: 'integer',
        description:
          'Number of fuel cells to burn or fuel units to transfer. Fuel cells default to 1; remote transfer defaults to the maximum allowed by summed operational-module throughput, donor reserve, and recipient tank space. Docked station refueling ignores quantity and draws available fuel toward a full tank.',
        positionalIndex: 1,
      },
      target: {
        type: 'string',
        description:
          "Player ID or username at the same real POI to receive fuel, or 'fleet' for read-only fleet fuel status. Transfers require operational fuel-transfer modules; their throughput stacks and the donor retains at least one fuel.",
      },
    },
  },
  'POST /api/v2/spacemolt/repair': {
    ...
    schema: {
      ...
      quantity: {
        type: 'integer',
        description:
          'Number of repair kits to use (default 1). Remote repair is capped by summed operational module throughput, available kits, and target hull need. Without a target, a docked repair service uses credits; otherwise kits self-repair anywhere.',
        positionalIndex: 1,
      },
      target: {
        type: 'string',
        description:
          "Player ID or username to repair at the same real POI, or 'fleet' for read-only fleet hull status. Ship-to-ship repair consumes repair kits and requires operational repair-arm modules; their throughput stacks and caps kits applied per action.",
      },
    },
  },
